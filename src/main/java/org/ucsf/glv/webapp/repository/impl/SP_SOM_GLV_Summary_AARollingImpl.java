...
public class SP_SOM_GLV_Summary_AARollingImpl implements SP_SOM_GLV_Summary_AARolling {
    ...
    public void execute(Connection connection, String sessionUserId, String deptCdGLV, String deptCdOverride, String businessUnitCd,
        ...
        Timestamp sesstionTime = new Timestamp(cal.getTimeInMillis());
            ...
            PreparedStatement employeeListRollingStatementFTEInsert = connection.prepareStatement(String.format(insertIntoEmployeeListRollingQuery, "'FTE'", 1, " X.RecType = 'XY' "));
            ...
            PreparedStatement employeeListRollingStatementRegPayInsert = connection.prepareStatement(String.format(insertIntoEmployeeListRollingQuery.replaceAll("\\[P", "[S"), "CASE WHEN X.RecType = 'XY' THEN 'RegPay' ELSE 'AddPay' END ", "CASE WHEN X.RecType = 'XY' THEN 2 ELSE 3 END ", " X.RecType NOT IN ('VLA') "));
    ...
    private PreparedStatement setValueForInsertIntoEmployeeListRollingStatement(PreparedStatement statement,
            String sessionUserId, Timestamp sesstionTime, int fy, int fp, String deptSite, String deptCdOverride)
            throws SQLException {
